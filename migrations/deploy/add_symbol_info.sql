...
INSERT INTO trading.assets(symbol, name) VALUES
    ('XAU', 'Gold'),
    ('USD', 'US Dollar');

INSERT INTO trading.exchanges(id, name) VALUES
    (1, 'MOCK');

INSERT INTO trading.symbol_infos(symbol, name, base_currency, quote_currency, exchange_id) VALUES
